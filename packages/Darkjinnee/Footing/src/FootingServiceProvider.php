...
class FootingServiceProvider extends ServiceProvider
{
    /**
    ...
    {
        $this->mergeConfigFrom(__DIR__.'/../config/footing.php', 'footing');

        // Register the service the package provides.
        $this->app->singleton('footing', function ($app) {
            return new Footing;
        });
    }
    ...
    protected function bootForConsole(): void
    {
        ...
        $this->publishes([
            __DIR__.'/../config/footing.php' => config_path('footing.php'),
        ], 'footing.config');
